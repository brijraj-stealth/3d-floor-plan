...
// DJ Equipment (Simple Discs & Buttons)
const discMaterial = new THREE.MeshStandardMaterial({ color: 0x222222, metalness: 0.9, roughness: 0.2 });
const disc1 = new THREE.Mesh(new THREE.CylinderGeometry(0.3, 0.3, 0.05, 20), discMaterial);
const disc2 = disc1.clone();
disc1.position.set(1.5, 1.3, -5.9);
disc2.position.set(2.3, 1.3, -5.9);
scene.add(disc1, disc2);
